...
*/
'use strict';function fa(a,c){if(a){if("string"===typeof a)return ia(a,c);var f=Object.prototype.toString.call(a).slice(8,-1);"Object"===f&&a.constructor&&(f=a.constructor.name);if("Map"===f||"Set"===f)return Array.from(a);if("Arguments"===f||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(f))return ia(a,c)}}function ia(a,c){if(null==c||c>a.length)c=a.length;for(var f=0,q=Array(c);f<c;f++)q[f]=a[f];return q}
function N(a,c){var f;if("undefined"===typeof Symbol||null==a[Symbol.iterator]){if(Array.isArray(a)||(f=fa(a))||c&&a&&"number"===typeof a.length){f&&(a=f);var q=0;c=function(){};return{s:c,n:function(){return q>=a.length?{done:!0}:{done:!1,value:a[q++]}},e:function(h){throw h;},f:c}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var v=!0,G=!1,t;return{s:function(){f=a[Symbol.iterator]()},
n:function(){var h=f.next();v=h.done;return h},e:function(h){G=!0;t=h},f:function(){try{v||null==f.return||f.return()}finally{if(G)throw t;}}}}function na(a){if("Identifier"===a.type)return a=a.name,"use"===a||/^use[A-Z0-9]/.test(a);if("MemberExpression"===a.type&&!a.computed&&na(a.property)){a=a.object;var c=/^[A-Z].*/;return"Identifier"===a.type&&c.test(a.name)}return!1}function oa(a){return"Identifier"===a.type&&/^[A-Z]/.test(a.name)}
...
a.parent.key}
function ya(a){function c(){return{isUsed:!1,isSatisfiedRecursively:!1,isSubtreeUsed:!1,children:new Map}}function f(k,n){n=n.split(".");n=N(n);var D;try{for(n.s();!(D=n.n()).done;){var H=D.value,I=k.children.get(H);I||(I=c(),k.children.set(H,I));k=I}}catch(J){n.e(J)}finally{n.f()}return k}function q(k,n,D){n=n.split(".");n=N(n);var H;try{for(n.s();!(H=n.n()).done;){var I=k.children.get(H.value);if(!I)break;D(I);k=I}}catch(J){n.e(J)}finally{n.f()}}function v(k,n,D,H){k.children.forEach(function(I,J){var S=
...
function za(a){var c=a.declaredDependenciesNode,f=a.componentScope,q=a.scope;return a.declaredDependencies.map(function(v){var G=v.key;v=f.variables.find(function(z){return z.name===G});if(null==v)return null;var t=v.defs[0];if(null==t)return null;if("Variable"===t.type&&"VariableDeclarator"===t.node.type&&"Identifier"===t.node.id.type&&null!=t.node.init){var h=V(t.node.init);if(null!=h)return[v,h]}return"FunctionName"===t.type&&"FunctionDeclaration"===t.node.type?[v,"function"]:"ClassName"===t.type&&
"ClassDeclaration"===t.node.type?[v,"class"]:null}).filter(Boolean).map(function(v){var G=v[0];v=v[1];var t=G.defs[0];a:{for(var h=!1,z=0;z<G.references.length;z++){var K=G.references[z];if(K.writeExpr)if(h){G=!0;break a}else{h=!0;continue}for(var x=K.from;x!==q&&null!=x;)x=x.upper;if(x!==q&&!Aa(c,K.identifier)){G=!0;break a}}G=!1}return{construction:t,depType:v,isUsedOutsideOfHook:G}})}
function Ba(a){return"MemberExpression"!==a.parent.type&&"OptionalMemberExpression"!==a.parent.type||a.parent.object!==a||"current"===a.parent.property.name||a.parent.computed||null!=a.parent.parent&&("CallExpression"===a.parent.parent.type||"OptionalCallExpression"===a.parent.parent.type)&&a.parent.parent.callee===a.parent?"MemberExpression"===a.type&&a.parent&&"AssignmentExpression"===a.parent.type&&a.parent.left===a?a.object:a:Ba(a.parent)}
function Ca(a,c,f){c&&(a.optional?c.has(f)||c.set(f,!0):c.set(f,!1))}
function Z(a,c){if("Identifier"===a.type||"JSXIdentifier"===a.type)return a=a.name,c&&c.set(a,!1),a;if("MemberExpression"!==a.type||a.computed){if("OptionalMemberExpression"!==a.type||a.computed){if("ChainExpression"!==a.type||a.computed)throw Error("Unsupported node type: "+a.type);a=a.expression;if("CallExpression"===a.type)throw Error("Unsupported node type: "+a.type);var f=Z(a.object,c),q=Z(a.property,null);f=f+"."+q;Ca(a,c,f);return f}f=Z(a.object,c);q=Z(a.property,null);f=f+"."+q;Ca(a,c,f);
return f}f=Z(a.object,c);q=Z(a.property,null);f=f+"."+q;Ca(a,c,f);return f}function Da(a){return"MemberExpression"!==a.type||"Identifier"!==a.object.type||"React"!==a.object.name||"Identifier"!==a.property.type||a.computed?a:a.property}
function Ga(a,c){var f=Da(a);if("Identifier"!==f.type)return-1;switch(f.name){case "useEffect":case "useLayoutEffect":case "useCallback":case "useMemo":return 0;case "useImperativeHandle":return 1;default:if(f===a&&c&&c.additionalHooks){try{var q=Z(f,null)}catch(v){if(/Unsupported node type/.test(v.message))return 0;throw v;}return c.additionalHooks.test(q)?0:-1}return-1}}
function Ha(a,c){for(var f=[a],q=null;f.length;){q=f.shift();if(("Identifier"===q.type||"JSXIdentifier"===q.type)&&q.type===c.type&&q.name===c.name&&q.range[0]===c.range[0]&&q.range[1]===c.range[1])return q;if(Aa(q,c)){a=0;for(var v=Object.entries(q);a<v.length;a++){var G=v[a],t=G[1];"parent"!==G[0]&&(Ia(t)?(t.parent=q,f.push(t)):Array.isArray(t)&&t.forEach(function(h){Ia(h)&&(h.parent=q,f.push(h))}))}}}return null}
function Ja(a){for(var c="",f=0;f<a.length;f++)c+=a[f],0===f&&2===a.length?c+=" and ":f===a.length-2&&2<a.length?c+=", and ":f<a.length-1&&(c+=", ");return c}function Ia(a){return"object"===typeof a&&null!==a&&!Array.isArray(a)&&"string"===typeof a.type}function Aa(a,c){return a.range[0]<=c.range[0]&&a.range[1]>=c.range[1]}exports.configs={recommended:{plugins:["react-hooks"],rules:{"react-hooks/rules-of-hooks":"error","react-hooks/exhaustive-deps":"warn"}}};
...
1}B.set(l.id,A);return A}var m=q.pop();if(0!==m.size){var p=new Set;K.cache=new Map;x.cache=new Map;M.cache=new Map;var w=x(h.initialSegment),k=wa(z),n=va(z),D=k?oa(k)||na(k):qa(z)||ua(z),H=Infinity,I=N(h.finalSegments),J;try{for(I.s();!(J=I.n()).done;){var S=J.value;if(S.reachable){var R=M(S);R<H&&(H=R)}}}catch(l){I.e(l)}finally{I.f()}m=N(m);var P;try{for(m.s();!(P=m.n()).done;){var ca=P.value,T=ca[0],ra=ca[1];if(T.reachable){var ja=0===T.nextSegments.length?H<=M(T):H<M(T),Q=K(T)*x(T),ha=p.has(T.id),
Y=N(ra),aa;try{for(Y.s();!(aa=Y.n()).done;){var F=aa.value;ha&&!pa(F,"use")&&a.report({node:F,message:'React Hook "'+a.getSource(F)+'" may be executed more than once. Possibly because it is called in a loop. React Hooks must be called in the exact same order in every component render.'});if(D){if(z.async&&a.report({node:F,message:'React Hook "'+a.getSource(F)+'" cannot be called in an async function.'}),!ha&&Q!==w&&!pa(F,"use")){var ba='React Hook "'+a.getSource(F)+'" is called conditionally. React Hooks must be called in the exact same order in every component render.'+
...
'" that is neither a React function component nor a custom React Hook function. React component names must start with an uppercase letter. React Hook names must start with the word "use".');a.report({node:F,message:U})}else if("Program"===z.type){var ka='React Hook "'+a.getSource(F)+'" cannot be called at the top level. React Hooks must be called in a React function component or a custom React Hook function.';a.report({node:F,message:ka})}else if(n&&!pa(F,"use")){var da='React Hook "'+a.getSource(F)+
'" cannot be called inside a callback. React Hooks must be called in a React function component or a custom React Hook function.';a.report({node:F,message:da})}}}catch(l){Y.e(l)}finally{Y.f()}}}}catch(l){m.e(l)}finally{m.f()}}},t.CallExpression=function(h){if(na(h.callee)){var z=q[q.length-1],K=v[v.length-1],x=z.get(K);x||(x=[],z.set(K,x));x.push(h.callee)}"Identifier"===h.callee.type&&("useEffect"===h.callee.name||xa(h.callee))&&0<h.arguments.length&&(f=h)},t.Identifier=function(h){null==f&&G.has(h)&&
"CallExpression"!==h.parent.type&&a.report({node:h,message:"`"+a.getSource(h)+'` is a function created with React Hook "useEffectEvent", and can only be called from the same component. They cannot be assigned to variables or passed down.'})},t["CallExpression:exit"]=function(h){h===f&&(f=null)},t.FunctionDeclaration=function(h){va(h)&&c(a.getScope())},t.ArrowFunctionExpression=function(h){va(h)&&c(a.getScope())},t}},"exhaustive-deps":{meta:{type:"suggestion",docs:{description:"verifies the list of dependencies for Hooks like useEffect and similar",
recommended:!0,url:"https://github.com/facebook/react/issues/14920"},fixable:"code",hasSuggestions:!0,schema:[{type:"object",additionalProperties:!1,enableDangerousAutofixThisMayCauseInfiniteLoops:!1,properties:{additionalHooks:{type:"string"},enableDangerousAutofixThisMayCauseInfiniteLoops:{type:"boolean"}}}]},create:function(a){function c(m){v&&Array.isArray(m.suggest)&&0<m.suggest.length&&(m.fix=m.suggest[0].fix);a.report(m)}function f(m,p){return function(w){if(p.has(w))return p.get(w);var k=
m(w);p.set(w,k);return k}}function q(m,p,w,k,n){function D(b){var d=N(b.references),e;try{for(d.s();!(e=d.n()).done;){var g=e.value;if(g.resolved&&S.has(g.resolved.scope)){var r=Ha(m,g.identifier),u=Ba(r),W=Z(u,ha),ea;if(ea=n&&"Identifier"===u.type&&("MemberExpression"===u.parent.type||"OptionalMemberExpression"===u.parent.type)&&!u.parent.computed&&"Identifier"===u.parent.property.type&&"current"===u.parent.property.name){for(var X=g.from,la=!1;X.block!==m;)"function"===X.type&&(la=null!=X.block.parent&&
"ReturnStatement"===X.block.parent.type),X=X.upper;ea=la}ea&&ja.set(W,{reference:g,dependencyNode:u});if("TSTypeQuery"!==u.parent.type&&"TSTypeReference"!==u.parent.type){var ma=g.resolved.defs[0];if(null!=ma&&(null==ma.node||ma.node.init!==m.parent)&&"TypeParameter"!==ma.type)if(Q.has(W))Q.get(W).references.push(g);else{var Ea=g.resolved,Ka=T(Ea)||ra(Ea);Q.set(W,{isStable:Ka,references:[g]})}}}}}catch(sa){d.e(sa)}finally{d.f()}b=N(b.childScopes);var Fa;try{for(b.s();!(Fa=b.n()).done;)D(Fa.value)}catch(sa){b.e(sa)}finally{b.f()}}
function H(b){b=b.split(".");for(var d="",e=0;e<b.length;e++){if(0!==e){var g=b.slice(0,e+1).join(".");g=!0===ha.get(g);d+=g?"?.":"."}d+=b[e]}return d}function I(b,d,e,g){return 0===b.size?null:(1<b.size?"":d+" ")+e+" "+(1<b.size?"dependencies":"dependency")+": "+Ja(Array.from(b).sort().map(function(r){return"'"+H(r)+"'"}))+(". Either "+g+" "+(1<b.size?"them":"it")+" or remove the dependency array.")}n&&m.async&&c({node:m,message:"Effect callbacks are synchronous to prevent race conditions. Put the async function inside:\n\nuseEffect(() => {\n  async function fetchData() {\n    // You can await here\n    const response = await MyAPI.getData(someId);\n    // ...\n  }\n  fetchData();\n}, [someId]); // Or [] if effect doesn't need props or state\n\nLearn more about data fetching with Hooks: https://reactjs.org/link/hooks-data-fetching"});
...
e});F.push({key:d,node:b});g||ba.add(d)}});var L=ya({dependencies:Q,declaredDependencies:F,stableDependencies:aa,externalDependencies:ba,isEffect:n});P=L.unnecessaryDependencies;var U=L.missingDependencies,ka=L.duplicateDependencies,da=L.suggestedDependencies;if(0===ka.size+U.size+P.size)za({declaredDependencies:F,declaredDependenciesNode:p,componentScope:R,scope:J}).forEach(function(b){var d=b.construction,e=b.isUsedOutsideOfHook;b=b.depType;var g="function"===b?"useCallback":"useMemo",r="function"===
...
"useMemo"===g?["useMemo(() => { return ","; })"]:["useCallback(",")"],la=X[1];return[ea.insertTextBefore(d.node.init,X[0]),ea.insertTextAfter(d.node.init,la)]}}]);c({node:d.node,message:u,suggest:W})});else{!n&&0<U.size&&(da=ya({dependencies:Q,declaredDependencies:[],stableDependencies:aa,externalDependencies:ba,isEffect:n}).suggestedDependencies);(function(){if(0===F.length)return!0;var b=F.map(function(e){return e.key}),d=b.slice().sort();return b.join(",")===d.join(",")})()&&da.sort();L="";if(0<
